import { CULTURE_INFO, NumberFormatOptions, formatNumber, formatNumberLocal, tryParseFloat, tryParseFloatISO, tryParseFloatLocal } from "utils";
...
it('formatNumbeLocal.currentCulture.hu', () => {
	REACT_SIMPLE_UTIL.CULTURE_INFO.CURRENT = CULTURE_INFO.HU;
...
it('tryParseFloatLocal.currentCulture.EN-US', () => {
	try {
		REACT_SIMPLE_UTIL.CULTURE_INFO.CURRENT = CULTURE_INFO["EN-US"];
